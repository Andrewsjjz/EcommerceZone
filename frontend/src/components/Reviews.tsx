            ...
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
              <div className="relative p-4 bg-white rounded-lg shadow dark:bg-white sm:p-5">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        focus:border-primary-600 block w-full p-2.5 dark:bg-slate-100 dark:border-gray-300 dark:placeholder-gray-400 
                  ...
                  <button
                    type="submit"
                    className="text-white inline-flex items-center bg-slate-600 hover:bg-slate-700 focus:ring-4 focus:outline-none 
                    focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-slate-600 
                    dark:hover:bg-slate-700 dark:focus:ring-primary-800"
                  >
                    <svg
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm">
            ...
            <p className="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">
              Queremos que tengas la mejor experiencia con este producto
            </p>
            <button
              onClick={() => {
                setShow(true);
              }}
              className="inline-flex items-center mx-3 px-3 py-2 text-sm font-medium text-center text-white 
              bg-slate-700 rounded-lg hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 
