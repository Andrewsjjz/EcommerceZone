...
const Header = () => {
  ...
  return (
    <Disclosure as="nav" className="bg-[#F8F3DD]">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-black hover:text-gray-500 dark:text-black dark:hover:text-slate-50">
                  ...
                  <div className="flex space-x-4">
                    {isAuth ? (
                      <>
                        <Link
                          to={"/"}
                          className="bg-slate-400 p-2 px-4 rounded-lg text-white dark:bg-slate-800"
                        >
                          Inicio
                        </Link>
                        ...
                        <Link
                          to={"/cate"}
                          className="text-black p-2 px-4 rounded-lg hover:bg-slate-400 dark:text-black dark:hover:bg-slate-400 dark:hover:text-white"
                        >
                          Categorias
                        </Link>
                      </>
              ...
              <div className="relative hidden md:block ">
                ...
                <input
                  ...
                  pl-10 text-sm text-black border border-gray-300 rounded-full 
                  bg-[#F9F5E3] outline-none dark:placeholder-gray-400
                  "
                  placeholder="Buscar"
                />
              </div>
              ...
              <div className="absolute space-x-2 inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Link
                  to={"/cart"}
                  className="text-slate-900 hover:text-black dark:text-black dark:hover:text-slate-400"
                >
